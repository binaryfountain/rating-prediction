...
dt_rt = dt[dt['CONTENT_y'].isin(['Overall Rating 4','Overall Rating 5'])]
...
dt_rt1 = dt[dt['CONTENT_y'].isin(['Overall Rating 4'])]
dt_rt11 = dt_rt1.sample(n=5000)
dt_rt2 = dt[dt['CONTENT_y'].isin(['Overall Rating 5'])]
...
d12.to_csv('/home/murali/Desktop/fifty_new_rating_4_5.csv',index=False)
...
# import pandas as pd
# d12 = pd.read_csv('/home/murali/Desktop/rating_4_5.csv')
# d12.shape
...
# d12.columns = ['DOCUMENT_ID','CONTENT_x','CONTENT_y']
...
torch.save(model, '/home/murali/Desktop/rating_data/mymodel/model_state_45.pt')
...
submission.to_csv('/home/murali/Desktop/submission_45.csv', index=False)
...
test['pred'] = np.where(test['target1'] <= 4.5,4,5)
