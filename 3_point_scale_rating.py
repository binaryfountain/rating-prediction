...
import pandas as pd
dt = pd.read_csv('/home/murali/Desktop/rating_data/consol.csv')
...
import numpy as np
dt['CONTENT_y'] = np.where(dt['CONTENT_y']=='Overall Rating 5','Overall Rating 4',dt['CONTENT_y'])
dt['CONTENT_y'] = np.where(dt['CONTENT_y']=='Overall Rating 1','Overall Rating 2',dt['CONTENT_y'])
...
# dt_rt = dt[dt['CONTENT'].isin(['Overall Rating 5','Overall Rating 4','Overall Rating 3','Overall Rating 2','Overall Rating 1'])]
...
d12 = d12[d12['len'] > 0 ]
d12.drop(['len'],axis=1,inplace=True)


# In[14]:


# ll=list(d22['CONTENT_x'])
# bb = list()
...
# bbb.columns = ['c1','c2','c3']
# bbb['n1'] = bbb['c1'].astype(str)
# bbb['gene'] = bbb['n1'].str.split(',').str[2]
# # bbb.dtypes
# bbb.drop(['c1','c2','c3'],axis=1,inplace=True)


# In[17]:


# d33 = pd.concat([d22,bbb],axis=1)
# d33.head(50)
...
# d22.to_csv('/home/murali/Desktop/d22.csv')
...
d_5 = d12[d12['CONTENT_y']=='Overall Rating 4']
# d_4 = d12[d12['CONTENT_y']=='Overall Rating 4']
d_3 = d12[d12['CONTENT_y']=='Overall Rating 3']
# d_2 = d12[d12['CONTENT_y']=='Overall Rating 2']
d_1 = d12[d12['CONTENT_y']=='Overall Rating 2']
d_11 = d_1.sample(n=10000)
# d_22 = d_2.sample(n=2400)
d_33 = d_3.sample(n=2500)
# d_44 = d_4.sample(n=2400)
d_55 = d_5.sample(n=10000)
...
# torch.save(model.state_dict(), '/home/murali/Desktop/rating_data/mymodel.pt')
# torch.save(model.state_dict(), '/home/murali/Desktop/rating_data/mymodel/model_state_all.pt')
# torch.save(model.state_dict(),'/home/murali/Desktop/rating_data/mymodel/model_state_all.pt')
torch.save(model, '/home/murali/Desktop/rating_data/mymodel/model_state_all.pt')
...
# torch.save(model, '/home/murali/Desktop/rating_data/mymodel/model_state.pt')


# In[44]:


# model = torch.load('/home/murali/Desktop/rating_data/mymodel.pt')
...
submission.to_csv('/home/murali/Desktop/submission_all.csv', index=False)
...
(1920+132+1623) / (1920+66+30+771+132+74+166+218+1623)
